...
\begin{problem}{Challenge II}
 ...
 \begin{enumerate}
  \item Are $3$ and $6$ co-prime?  \hfill Yes~~\AnsT{No}
  \item Are $8$ and $13$ co-prime? \hfill \AnsT{Yes}~~No
  \item Are $9$ and $16$ co-prime? \hfill \AnsT{Yes}~~No
  \item Fill in the blanks with integers so that the following equation is true:
...
\begin{problem}{Challenge III}
 ...
 their shared prime factor. \Ans{97}
\end{problem}
