...
\begin{problem}{Garden Dimensions}
 ...
 \begin{enumerate}[\hspace{1cm}a.]
   ...
   \Switch{\Ans{\SI{3}{\metre}\times\SI{12}{\metre}}}{}
   \item \ldots{}the length and width are equal?
   \Switch{\Ans{\SI{6}{\metre}\times\SI{6}{\metre}}}{}
   \item \ldots{}the perimeter is \SI{26}{\metre}?
   \Switch{\Ans{\SI{4}{\metre}\times\SI{9}{\metre}}}{}
 \end{enumerate}
\end{problem}
...
\begin{problem}{Units of Money}
  ...
  \hfill \Switch{\AnsT{\(10\) \textcent}}{\blankC\textcent}
\end{problem}
...
\begin{problem}{Dimensional Analysis}
  ...
  \begin{itemize}
    ...
    \item \MCSelect{\(\SI{17}{\kilo\metre} \times \SI{17}{\centi\metre} =
