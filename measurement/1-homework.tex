...
\begin{problem}{Unit Conversion}
  ...
  \hfill \Switch{\Ans{\SI{300000}{\centi\metre}}}{\blankE \si{\centi\metre}}
\end{problem}
...
\begin{problem}{Acute, Right, Obtuse}
 ...
 \begin{itemize}
  \item \SI{123}{\degree} \hfill Acute~~Right~~\MCSelect{Obtuse}
  \item \SI{88}{\degree} \hfill \MCSelect{Acute}~~Right~~Obtuse
  \item \SI{90}{\degree} \hfill Acute~~\MCSelect{Right}~~Obtuse
 \end{itemize}
\end{problem}
...
\begin{problem}{Angle sum}
 \begin{itemize}
  \item The sum of an acute angle and a right angle is:
        \hfill Acute~~Right~~\MCSelect{Obtuse}
  \item Half of a right angle is:
        \hfill \MCSelect{Acute}~~Right~~Obtuse
 \end{itemize}
\end{problem}
...
\begin{problem}{Lines II}
 ...
 line.) \Switch{\begin{center}\begin{tikzpicture}
  \draw[->] (0,0) -- (2,0);
  \draw[->] (3,-3) -- (3,-1);
...
\begin{enumerate}
 ...
 angles? \Switch{\Ans{\SI{1080}{\degree}}}{}
