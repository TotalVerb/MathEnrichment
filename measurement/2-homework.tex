...
\begin{problem}{Unit Conversion}
  ...
  in degrees? \Switch{\Ans{\SI{160}{\degree}}}{\hfill \blankE \si{\degree}}
\end{problem}
...
\begin{problem}{Angle Sum of a Triangle II}
 ...
 \begin{itemize}
  ...
  \hfill Possible~~\MCSelect{Not Possible}
  \item A triangle has three acute angles.
  \hfill \MCSelect{Possible}~~Not Possible
 \end{itemize}
\end{problem}
...
\begin{problem}{Angle Sum of a Triangle III}
 ...
 \begin{itemize}
  ...
  \Switch{\Ans{\SI{10}{\degree}}}{\blankC \si{\degree}}
  \item \SI{30}{\degree}, \SI{60}{\degree},
  \Switch{\Ans{\SI{90}{\degree}}}{\blankC \si{\degree}}
  \item \SI{90}{\degree}, \SI{45}{\degree},
  \Switch{\Ans{\SI{45}{\degree}}}{\blankC \si{\degree}}
 \end{itemize}
\end{problem}
...
\begin{problem}{Angle Sum of a Polygon}
 ...
 \begin{itemize}
  ...
  \hfill Sum: \Switch{\Ans{\SI{720}{\degree}}}{\blankC \si{\degree}}
  \item Hendecagon (\(11\)-sided)
  \hfill Sum: \Switch{\Ans{\SI{1620}{\degree}}}{\blankC \si{\degree}}
 \end{itemize}
\end{problem}
...
\begin{problem}{Challenge I}
 ...
 \begin{itemize}
  ...
  of this triangle? \Switch{\Ans{\SI{360}{\degree}}}{}
  ...
  you notice? \Switch{\Ans{\SI{360}{\degree}}}{}
  ...
  add those up. \Switch{\Ans{\SI{360}{\degree}}}{}
  \item What is true about the sum of exterior angles of any polygon? Why do
  you think this is the case? \Switch{\Ans{\SI{360}{\degree}}}{}
 \end{itemize}
\end{problem}
