...
\noindent (Optional) Show work on the scrap paper. Part marks are awarded for work done.

\noindent All angles that look right are right. All lines
that look parallel are parallel.

\noindent Calculators are permitted but are not needed.
Reference formulas on bottom of back page.
...
$A_\text{parallelogram}=bh$, $A_\text{trapezoid}=\frac{1}{2}\left(b_1+b_2\right)h$
