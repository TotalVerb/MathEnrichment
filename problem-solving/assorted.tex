...
\begin{problem}{A Study in Scarlet}
 ...
 area than it is on length. \Switch{\Ans{\SI{36}{\centi\metre\squared}}}{}
\end{problem}
...
\begin{problem}{The Fourth Floor}
 ...
 \begin{enumerate}[\hspace{1cm}a.]
  \item How many people exited at the third floor? \hfill \SAF{8}
  \item How many people entered the elevator at the first floor? \hfill \SAF{11}
 \end{enumerate}
\end{problem}
...
\begin{problem}{Complete the Pattern}
 ...
 \begin{enumerate}[\hspace{1cm}a.]
   \item 1, 1, 1, 1, \SAC{1}, \SAC{1}
   \item A, B, C, D, E, \STC{F}, \STC{G}
   \item 2, 4, 6, 8, \SAC{10}, \SAC{12}
   \item 3, 9, 27, 81, \SAC{243}, \SAC{729}
   \item $\uparrow$, $\leftarrow$, $\downarrow$, $\rightarrow$, $\uparrow$,
   $\leftarrow$, \SAC{\downarrow}, \SAC{\rightarrow}
   \item O, T, T, F, F, S, S, E, \STC{N}, \STC{T}
   \item 1, 2, 6, 24, 120, 720, \SAC{5040}, \SAC{40320}
   \item 0, 1, 1, 2, 3, 5, 8, 13, 21, \SAC{34}, \SAC{55}
 \end{enumerate}
\end{problem}
