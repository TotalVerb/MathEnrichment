...
\newglossaryentry{additive inverse}
{
  ...
  description={the opposite of a number on the number line; for \(a\) the
  additive inverse is denoted \(-a\); it is always the case that \(a + (-a) =
  0\)}
}
...
\newglossaryentry{fraction}
{
  name=fraction,
  description={pair of two numbers, a numerator and a denominator, representing
...
{
  name=objective,
  description={a goal; in the context of optimization, this is the quantity we are trying to
  improve}
}
...
\newglossaryentry{rational number}
{
  ...
  description={a number that can be represented by the fraction of two
  integers}
}
